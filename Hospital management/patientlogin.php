...
if(isset($_POST['submit']))
{
    ...
    {
        $rspatient = mysqli_fetch_array($qsql);
        
        // Verify the password
        if(password_verify($_POST['password'], $rspatient['password']))
        {
            $_SESSION['patientid'] = $rspatient['patientid'];
            $_SESSION['patientname'] = $rspatient['patientname'];
            echo "<script>window.location='patientaccount.php';</script>";
        }
        else
        {
